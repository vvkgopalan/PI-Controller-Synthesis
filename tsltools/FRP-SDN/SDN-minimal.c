/*Vivek Gopalan
modification of example1.c code
need to figure out how to use PI
additional compilation/testing problems since it uses automake for the makefile
*/
#ifndef TESTDATADIR
#define TESTDATADIR "testdata" //want to grab simple_router.json from testdata directory - need to look into this
#endif

#include "PI/include/PI/frontends/generic/pi.h" //if I'm moving folders, I need to make sure the relative paths to the pi.h required header files are changed

#include "_assert.h" //not in g++, need to get assert into g++ using smth
